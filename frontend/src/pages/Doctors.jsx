  ...
  return (
    <div>
      ...
      <div className="flex flex-col sm:flex-row items-start gap-5 mt-5">
        ...
        <div
          className={`flex-col gap-4 text-sm text-gray-700 ${
        ...
        >
          <p
            ...
            className={`w-[94vm] sm:w-auto p1-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${
              speciality === "General physician"
